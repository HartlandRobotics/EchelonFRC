...
public class ExportActivity extends EchelonActivity {
    ...
    private Button exportRedThreeMatchResultsButton;
    private Button exportBlueOneMatchResultsButton;
    private Button exportBlueTwoMatchResultsButton;
    ...
    public void setupExportCSVButton() {
        ...
        exportRedOneMatchResultsButton.setOnClickListener((view) -> {
            try {
        ...
        exportRedTwoMatchResultsButton.setOnClickListener((view) -> {
            try {
        ...
        exportRedThreeMatchResultsButton.setOnClickListener((view) -> {
            try {
        ...
        exportBlueOneMatchResultsButton.setOnClickListener((view) -> {
            try {
        ...
        exportBlueTwoMatchResultsButton.setOnClickListener((view) -> {
            try {
        ...
        exportBlueThreeMatchResultsButton.setOnClickListener((view) -> {
            try {
                ...
                try {
                    ...
                    for (PitScout ps : pitScoutResults) {
                        content.append("<a href=\"#" + ps.getTeamKey().substring(3) + " \"><h2 id=" + ps.getTeamKey().substring(3) + " class=team> Team " + ps.getTeamKey().substring(3) + "</h2> </a>")
                                ...
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you go over the hump?</p>")
                                .append("<p class=answer>").append(ps.getTraversesHump()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you go under the trench?</p>")
                                .append("<p class=answer>").append(ps.getUnderTrench()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>What is your shooter type?</p>")
                                .append("<p class=answer>").append(ps.getShooterType()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>What is your robot size?</p>")
                                .append("<p class=answer>").append(ps.getRobotSize()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>What is your intake size?</p>")
                                .append("<p class=answer>").append(ps.getIntakeSize()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Does over bumper intake?</p>")
                                .append("<p class=answer>").append(ps.getIntakeType() == 0).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Does passthrough bumper intake?</p>")
                                .append("<p class=answer>").append(ps.getIntakeType() == 1).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>What is their maximum fuel capacity?</p>")
                                .append("<p class=answer>").append(ps.getFuelCapacity()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can they obtain fuel from the ground?</p>")
                                .append("<p class=answer>").append(ps.getGroundFuel()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can they obtain fuel from the Human Player Station?</p>")
                                .append("<p class=answer>").append(ps.getHumanFuel()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How accurate is your human player?</p>")
                                .append("<p class=answer>").append(StringUtils.defaultIfBlank(ps.getHumanAccuracy(),StringUtils.EMPTY)).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Additional Notes?</p>")
                                .append("<p class=answer>").append(StringUtils.defaultIfBlank(ps.getAdditionalNotes(),StringUtils.EMPTY)).append("</p>")
                                .append("</li>")
                        ...
                        content.append("<li>")
                                ...
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you hang?</p>")
                                .append("<p class=answer>").append(ps.getAutoHang()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Where do you hang?</p>")
                                .append("<p class=answer>").append(ps.getAutoWhereHang()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How do you hang?</p>")
                                .append("<p class=answer>").append(ps.getAutoHowHang()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you go over the center line?</p>")
                                .append("<p class=answer>").append(ps.getAutoCenterLine()).append("</p>")
                                .append("</li>")
                                .append("</ol>")
                                ...
                                .append("<ol>")
                                .append("<li>")
                                .append("<p class=question>Can you pass?</p>")
                                .append ("<p class=answer>").append(ps.getTeleOpCanPass()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you prefer scoring?</p>")
                                .append ("<p class=answer>").append(ps.getRolePreference() == 0).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you prefer passing?</p>")
                                .append ("<p class=answer>").append(ps.getRolePreference() == 1).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you prefer neither?</p>")
                                .append ("<p class=answer>").append(ps.getRolePreference() == 3).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you have experience playing defense?</p>")
                                .append ("<p class=answer>").append(ps.getDefenseExperience()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How long does it take you to fill your robot?</p>")
                                .append ("<p class=answer>").append(ps.getFuelPerSecondIngest()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How long does it take you to empty your robot?</p>")
                                .append ("<p class=answer>").append(ps.getFuelPerSecondShoot()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you shoot while moving?</p>")
                                .append ("<p class=answer>").append(ps.getHowShoot() == 0).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Do you shoot while staying still?</p>")
                                .append ("<p class=answer>").append(ps.getHowShoot() == 1).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>What is your shooting position?</p>")
                                .append("<p class=answer>").append(StringUtils.defaultIfBlank(ps.getTeleOpPosition(),StringUtils.EMPTY)).append("</p>")
                                .append("</li>")
                                .append("</ol>")
                                ...
                                .append("<li>")
                                .append("<p class=question>Can you hang?</p>")
                                .append ("<p class=answer>").append(ps.getEndHang()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How many seconds does it take you to hang?</p>")
                                .append ("<p class=answer>").append(ps.getHangTime()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Where do you hang?</p>")
                                .append("<p class=answer>").append(StringUtils.defaultIfBlank(ps.getEndWhereHang(),StringUtils.EMPTY)).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>How do you hang?</p>")
                                .append("<p class=answer>").append(StringUtils.defaultIfBlank(ps.getEndHowHang(),StringUtils.EMPTY)).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you hang high?</p>")
                                .append ("<p class=answer>").append(ps.getEndHighClimb()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you hang mid?</p>")
                                .append ("<p class=answer>").append(ps.getEndMidClimb()).append("</p>")
                                .append("</li>")
                                .append("<li>")
                                .append("<p class=question>Can you hang low?</p>")
                                .append ("<p class=answer>").append(ps.getEndLowClimb()).append("</p>")
                                .append("</li>")
